...
class jabatanController extends Controller
{
        ...
        // $this->validate($request,['kode_g' => 'required|unique:jabatans,kode_g',
    {
        ...
        $sms=[
            'kode_j.required' => 'Tidak Boleh Kosong',
            'kode_j.unique' => 'Data Sudah Ada',
            'nama_j.required' => 'Tidak Boleh Kosong',
            'besar_uang.required' => 'Tidak Boleh Kosong',
            ];
    ...
    public function update(Request $request, $id)
    {
        ...
        $sms=[
            'kode_j.required' => 'Tidak Boleh kosong',
            'kode_j.unique' => 'Tidak Boleh sama',
            'nama_j.required' => 'Tidak Boleh kosong',
            'besar_uang.required' => 'Tidak Boleh kosong',
            ];
        $validasi = Validator::make(Input::all(),$rules,$sms);
